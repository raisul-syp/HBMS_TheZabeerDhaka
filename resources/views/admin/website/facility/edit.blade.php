...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/website/facilities/edit/'.$facility->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="tab-pane fade active show" id="facility_info" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="number" class="form-control" id="display_order" name="display_order" value="{{ $facility->display_order }}" placeholder="Add 2nd Button Title...">
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <textarea class="form-control" name="description" id="description" rows="3" placeholder="Add Description...">{{ $facility->description }}</textarea>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="image">
                                            {{ __('Image') }}
                                        </label>
                                        <input type="file" class="dropify" id="image" name="image" data-default-file="{{ asset('frontend/images/facilities/'.$facility->image) }}" />
                                    </div>
                                </div>
                            </div>
