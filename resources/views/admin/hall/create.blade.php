...
@section('title', 'Create A New Hall')
...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Create A New Hall') }}</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Halls') }}</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Add Hall') }}</a></li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/hall') }}" method="POST" enctype="multipart/form-data">
                @csrf
