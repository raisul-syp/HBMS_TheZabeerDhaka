...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Edit Offer') }}</h2>
                <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/offers/edit/'.$offer->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane fade active show" id="offer_info" role="tabpanel">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $offer->name }}" placeholder="Add Name...">
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="slug" name="slug" value="{{ $offer->slug }}" placeholder="Add Slug...">
                                        @error('slug')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="short_description" name="short_description" rows="3" placeholder="Add Short Description...">{{ $offer->short_description }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="long_description" name="long_description">{{ $offer->long_description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="datetime-local" class="form-control" id="start_date" name="start_date" value="{{ $offer->start_date }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="datetime-local" class="form-control" id="end_date" name="end_date" value="{{ $offer->end_date }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="switch switch-square">
                                            <input type="checkbox" class="switch-input" id="is_active" name="is_active" {{ $offer->is_active == '1' ? 'checked':'' }}>
                            ...
                            <div class="tab-pane fade" id="offer_image" role="tabpanel">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="dropify" id="thumb" name="thumb" data-default-file="{{ asset('uploads/offer/'.$offer->thumb) }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="offer_seo" role="tabpanel">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ $offer->meta_title }}" placeholder="Add Meta Title...">
                                        @error('meta_title')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="meta_keyword" name="meta_keyword" value="{{ $offer->meta_keyword }}" placeholder="Add Meta Keyword...">
                                        @error('meta_keyword')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="meta_decription" name="meta_decription" rows="4" placeholder="Add Meta Description...">{{ $offer->meta_decription }}</textarea>
                                    </div>
                                </div>
