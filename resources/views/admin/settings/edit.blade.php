...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Edit Settings') }}</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Settings') }}</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Edit Settings') }}</a></li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/settings/edit/'.$settings->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane fade active show" id="settings_info" role="tabpanel">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $settings->name }}" placeholder="Add Name...">
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" id="phone" name="phone" value="{{ $settings->phone }}" placeholder="Add Phone...">
                                            @error('phone')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email" value="{{ $settings->email }}" placeholder="Add Email...">
                                            @error('email')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" name="address" id="address" rows="3" placeholder="Add Address...">{{ $settings->address }}</textarea>
                                            @error('address')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="display_order" name="display_order" value="{{ $settings->display_order }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" {{ $settings->is_active == '1' ? 'checked':'' }}>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="social_fb" name="social_fb" value="{{ $settings->social_fb }}" placeholder="Add Facebook URL...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="social_tw" name="social_tw" value="{{ $settings->social_tw }}" placeholder="Add Twitter URL...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="social_insta" name="social_insta" value="{{ $settings->social_insta }}" placeholder="Add Instagram URL...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="social_yt" name="social_yt" value="{{ $settings->social_yt }}" placeholder="Add Youtube URL...">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="settings_seo" role="tabpanel">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ $settings->meta_title }}" placeholder="Add Meta Title...">
                                        @error('meta_title')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="meta_keyword" name="meta_keyword" value="{{ $settings->meta_keyword }}" placeholder="Add Meta Keyword...">
                                        @error('meta_keyword')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="meta_decription" name="meta_decription" rows="4" placeholder="Add Meta Description...">{{ $settings->meta_decription }}</textarea>
                                    </div>
                                </div>
