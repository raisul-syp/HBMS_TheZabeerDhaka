...
@section('title', 'Create A New FAQ')
    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Create A New FAQ') }}</h2>
                <ol class="breadcrumb">
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane fade active show" id="faq_info" role="tabpanel">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control js-basic-single" id="faq_type" name="faq_type" >
                                            ...
                                            <option value="Best Rate Guarantee">Best Rate Guarantee</option>
                                        </select>
                                        @error('faq_type')
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug" placeholder="Add Slug..." hidden>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="answer" name="answer" rows="5" placeholder="Add Answer..."></textarea>
                                        @error('answer')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
