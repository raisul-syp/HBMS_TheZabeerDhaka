...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Edit Permission') }}</h2>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Edit Permission') }}</a></li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/role-permission/permission/edit/'.$permission->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane fade active show" id="permission_info" role="tabpanel">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $permission->name }}" placeholder="Add Name...">
                                        @error('name')
